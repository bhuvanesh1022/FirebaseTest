...
public abstract class CMSGridCellElement : MonoBehaviour {
	[SerializeField] protected Button removeButton;

	public delegate void RemoveEvent(CMSGridCellElement element);
...
public class CMSLayout<CellType> where CellType : CMSGridCellElement {
	...
	public CellType Add() {
		...
		(newCell as CMSGridCellElement).OnRemove += cell => {
